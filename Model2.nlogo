...
;
;  let x count patches with [ attraction > 14.9 ]
;
;  let y count patches with [ attraction > 19.9 ]
;
;  let sub1 (x - y)
;
;  let z count patches with [ attraction > 24.9 ]
;
;  let sub2 (y - z)
;
;  let ze1 count patches with [ attraction > 29.9 ]
;
;  let sub3 (z - ze1)
;
;  let ad (sub1 + sub2 + sub3)
;
